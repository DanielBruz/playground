...
class Duck(games.Sprite):
    ...
    def __init__(self, duckType):
        ...
        self.flyRight = [3, games.load_image("Sprites/" + duckColor + "/duck1.png"),
                         games.load_image("Sprites/" + duckColor + "/duck2.png"),
                         games.load_image("Sprites/" + duckColor + "/duck3.png")]

        self.flyStraightRight = [3, games.load_image("Sprites/" + duckColor + "/duck4.png"),
                                 games.load_image("Sprites/" + duckColor + "/duck5.png"),
                                 games.load_image("Sprites/" + duckColor + "/duck6.png")]

        self.flyLeft = [3, games.load_image("Sprites/" + duckColor + "/duck7.png"),
                        games.load_image("Sprites/" + duckColor + "/duck8.png"),
                        games.load_image("Sprites/" + duckColor + "/duck9.png")]

        self.flyStraightLeft = [3, games.load_image("Sprites/" + duckColor + "/duck10.png"),
                                games.load_image("Sprites/" + duckColor + "/duck11.png"),
                                games.load_image("Sprites/" + duckColor + "/duck12.png")]

        self.die = [3, games.load_image("Sprites/" + duckColor + "/duckDie1.png"),
                    games.load_image("Sprites/" + duckColor + "/duckDie2.png"),
...
class Game(games.Sprite):
    ...
    def __init__(self):
        ...
        # Instructions Labels
        self.instructions = games.Text(value="Shoot as many ducks as possible in 1 minute!", size=35, x=320, y=100,
                                       color=color.white)
